...
ProjectNumber = input(f"Enter Project Pcode(4 digit for Forsta, 6 digit for Confirmit): ")
if ProjectNumber == "":
...
#Take input for project details
CFSaas = input(f"Is it the Forsta project, Enter y if Forsta and n if Confirmit (y/n): ")
if CFSaas == "":
